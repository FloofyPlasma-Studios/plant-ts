...
export const PlayerFacingString = {
	...
	ValueManager: {
		// Unique strings used as keys for ValueManager offsets and multipliers
		Sprint: "sprint",
		ViewingMenu: "viewingMenu",
		PullingWagon: "pullingWagon",
	},
	Formats: {
		// Passed to string.format() with values substituting the placeholders
		CoinBundleShop: {
	...
	CallToAction: {
		// Action text on ProximityPrompt CTAs
